...
import { Tractor, Sprout, LeafyGreen, Users, LineChart } from "lucide-react";
              ...
              <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="pt-2">
                  {isProcessing ? (
                    ...
                    <button
                      type="submit"
                      className="w-full py-3 px-4 cursor-pointer bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition duration-200 cursor-pointer"
                    >
                      Register as Farmer
                    </button>
                  )}
